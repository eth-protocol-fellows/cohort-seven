...
This repository is dedicated to coordination and resources for EPF Cohort 7
...
> [!IMPORTANT]  
> Read the [announcement blog](TBD) and [submit your application](https://epf.wiki/#/wiki/epf)!
...
To learn about the protocol and prepare for the fellowship, use resources in [EPF.wiki](https://epf.wiki/#/wiki/epf). To find ideas for projects, see [proposed projects](/projects/project-ideas.md). 
