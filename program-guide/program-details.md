...
Learn more about EPF and the previous cohort in the [sixth cohort recap](https://ps.ethereum.foundation/blog/epf6-recap) and [intro town hall](TBD).
...
You don't have to be a senior software developer. But almost everyone who is successful in core development has some ability to use code to implement, therefore the cohort focuses mainly on software engineers. 
...
The program will run for 5 months, from June through mid-November. This gives us the opportunity to organize a physical meetup at [Devconnect](https://devconnect.org) in Mumbai.

Timeline of the 5 month program will follow these stages:

### Phase Zero
- Those selected for EPF7 should spend the month prior getting up to speed on the current state of the art in Ethereum protocol development. A great place for this is [epf.wiki](https://epf.wiki) and our [reading list](./reading.md)
### Phase One
...
- In-person event at Devconnect in Mumbai
