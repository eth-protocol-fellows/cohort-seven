...
Here are some frequently asked questions about the EPF program. You can also watch the [EPF7 Town Hall](TBD) presentation for an introduction to the current cohort and answers to common questions.
...
- **When does it start and what is the duration?**
    - Program will start in June 2026 and continue for 5 months, culminating with an in-person event at [Devconnect](https://devconnect.org/) in Mumbai in November. 
