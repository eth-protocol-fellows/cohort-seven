...
- Add a comment in the [Office Hours](https://github.com/eth-protocol-fellows/cohort-seven/issues) issue in the GitHub repo for the upcoming meeting outlining the problem you are having or the discussion you would like to happen
